...
var DQNAgent = function(env, opt) {
  ...
  this.num_hidden_units_1 =  getopt(opt, 'num_hidden_units_1', 50); 
  this.num_hidden_units_2 =  getopt(opt, 'num_hidden_units_2', 50); 
...
DQNAgent.prototype = {
  reset: function() {
    this.nh1 = this.num_hidden_units_1; // number of units in hidden layer 1
    this.nh2 = this.num_hidden_units_2; // number of units in hidden layer 2
    ...
    this.net.W1 = new R.RandMat(this.nh1, this.ns, 0, 0.01);
    this.net.b1 = new R.Mat(this.nh1, 1, 0, 0.01);
    this.net.W2 = new R.RandMat(this.nh2, this.nh1, 0, 0.01);
    this.net.b2 = new R.Mat(this.nh2, 1, 0, 0.01);
    this.net.W3 = new R.RandMat(this.na, this.nh2, 0, 0.01);
